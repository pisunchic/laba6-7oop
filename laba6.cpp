...
DWORD WINAPI ThreadFun(LPVOID par) {
    ForThread* pData = (ForThread*)par; //указатель на структуру
    WaitForSingleObject(hEvent, INFINITE); //приостанавливает выполнение потока до тех пор, пока не будет получен сигнал
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        pF[0] = new MyTri(85, 1, 10, 0, RGB(255, 0, 0), hWnd, 3);
